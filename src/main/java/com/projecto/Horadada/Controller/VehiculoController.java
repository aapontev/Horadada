...
public class VehiculoController {
    ...
    public String vehiculos(@RequestParam(name = "page", defaultValue = "0") int page, Model model) {
        ...
        Page<VehiculoEntity> vehiculo = utilitarioservice.findAll(pageRequest);
        PageRender<VehiculoEntity> pagerender = new PageRender<VehiculoEntity>("/Vehiculo", vehiculo);
    ...
    public String redirectPersonaForm(@RequestParam(name = "id", required = false) int id, Model model) {
        ...
        List<TransportistaEntity> transportista = transportistaservice.findByAll();
        if (id != 0) {
    ...
    public String addPersona(@ModelAttribute(name = "vehiculo") VehiculoEntity vehiculo, Model model) {
