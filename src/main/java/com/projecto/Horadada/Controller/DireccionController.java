...
public class DireccionController {
	...
	public String DireccionList(@RequestParam(name = "page", defaultValue = "0") int page, Model model) {
		...
		Page<Direccion> direccion = utilitarioservice.findAllDir(pageRequest);
		PageRender<Direccion> pagerender = new PageRender<Direccion>("/direccion", direccion);
	...
	public String addDireccion(@ModelAttribute("direccion")Direccion direccion, Model model) {
